function Footer() {
  return (
    <footer className="mt-auto bg-white px-7 pb-10 pt-2 text-black dark:bg-neutral-900 dark:text-slate-200">
      <div
        id="contact"
        className="flex gap-4 py-3 text-[#591D87] dark:text-[#D0BCFF] [&>*]:rounded-full [&>*]:bg-[#F6F4F8] [&>*]:p-2 [&>*]:dark:bg-[#1B1A1E]"
      >
        <a
          href="https://t.me/qqqyyyttwwrr"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:brightness-90 dark:hover:brightness-110"
        >
          <svg
        ...
        <a
          href="https://www.instagram.com/adil96755/"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:brightness-90 dark:hover:brightness-110"
        >
        ...
        <a
          href="https://www.linkedin.com/in/adil-kenzhiyev-24a241241/"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:brightness-90 dark:hover:brightness-110"
        >
        ...
        <a
          href="https://github.com/neobyvatel/SkyCast"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:brightness-90 dark:hover:brightness-110"
        >
      ...
      <hr className="mb-4 border-black dark:border-neutral-300" />
      <div className="flex flex-col justify-between gap-3 md:flex-row">
        <div>
          <p>
            ...
            <br />
            <span className="font-bold">&copy; 2023</span>
          </p>
        </div>
      </div>
    </footer>
