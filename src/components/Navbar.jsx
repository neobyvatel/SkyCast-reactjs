...
const Header = () => {
  ...
  return (
    <div className="bg-white-100/30 fixed top-0 z-50 w-full text-gray-200 shadow-sm backdrop-blur-lg backdrop-filter  ">
      <div className="mx-auto flex max-w-screen-xl flex-col px-4 md:flex-row md:items-center md:justify-between md:px-6 lg:px-8">
        ...
        >
          ...
          <a
            ...
            className="mt-2 flex items-center gap-2 rounded-lg px-4 py-2 text-sm transition-all hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-gray-600 md:ml-4 md:mt-0 md:bg-transparent md:px-0 md:py-0 md:hover:bg-transparent md:hover:text-gray-500"
          >
            <svg
